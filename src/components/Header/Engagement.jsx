...
export default function Engagement(){
    ...
    return(
        <section className="h-fit py-20 md:h-screen w-full relative words-section flex flex-col gap-y-8 px-4 sm:py-0 sm:pt-10 sm:block sm:px-0">
            ...
            <div className="h-[45px] w-[650px] overflow-hidden relative">
            ...
            <img className="w-full aspect-auto sm:w-2/4 sm:object-cover sm:absolute sm:right-20 sm:top-1/4" src="./images/info-img.svg" alt="Imagen de yate navegando" />
